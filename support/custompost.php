...
function custom_post_type() {
	...
	$txtdomain = 'archanelandscape';

	$labels = array(
		'name'                  => _x( 'Projects', 'Post Type General Name', $txtdomain ),
		'singular_name'         => _x( 'Project', 'Post Type Singular Name', $txtdomain ),
		'menu_name'             => __( 'Projects', $txtdomain ),
